		...
		<Card>
			<CardBody>
				<div className='flex flex-col gap-2'>
					<div
						className={`flex h-16 w-16 items-center justify-center rounded-full ${css}`}>
					...
					<div className='text-4xl font-semibold'>
						{totalRegistros} <span className='text-2xl'>Registros totales</span>
					</div>
					<div className='flex'>
						<Balance status='positive'>Ultimo registro: {fechaUltimoRegistro}</Balance>
					</div>
				</div>
			</CardBody>
		</Card>
