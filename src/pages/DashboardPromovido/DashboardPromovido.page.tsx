			...
			<Container>
				...
				<div className='grid grid-cols-2 gap-4'>
					{seriesGenero ? (
						<div className='mt-16 '>
							<PieChart
								colores={['#9235F2', '#F235C0', '#F5ECF1']}
								series={seriesApoyaElMovimiento}
								titulo='Apoyan el movimiento'
							/>
						</div>
					) : (
						<Spinner fullView={false} />
					...
					{seriesGenero ? (
						<div className='mt-16 '>
							<PieChart
								colores={['#355FF2', '#D335F2', '#F23581']}
								series={seriesGenero}
								titulo='Promovidos por genero'
							/>
						</div>
					) : (
						<Spinner fullView={false} />
