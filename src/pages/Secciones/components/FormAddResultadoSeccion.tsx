...
const FormAddResultadoSeccion = ({ handleCloseModal, coaliciones, seccion }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async () => {
            ...
            if(esEdicion){
                await _creatorService.votosSeccionesService.ActualizarVotosPorCasilla(seccion.idSeccion,payload)
            }else {
    ...
    const obtenerVotosPorCasilla = async () =>{
        ...
        const votos = await _creatorService.votosSeccionesService.obtenerVotosPorCasilla(seccion.idSeccion)
