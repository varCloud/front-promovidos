...
const GoogleSearchBoxWithMap = ({ height = "500px", handleChangeMarker, direccionToSearch }) => {
    ...
    const onchangePlace = async (_value) => {
        ...
        const latLngValue = { lat: LatLn[0].geometry.location.lat() ?? 0, lng: LatLn[0].geometry.location.lng() ?? 0 }
        setCurrentMarker({ ...latLngValue })
        setPropsMapa({ latLngValue: latLngValue, _value : _value })
        setZoom(20)
        handleChangeMarker({ latLngValue: latLngValue, _value : _value })
    }
    ...
    const onDragEnd = (e) => {
        ...
        setCurrentMarker({ ...latLngValue })
        setPropsMapa({...propsMapa , latLngValue:latLngValue})
        ...
        <>
            ...
            <APIProvider apiKey={URIS_CONFIG.GOOGLE_KEY}>
                <Map
                    ...
                    onBoundsChanged={evt => { console.log(evt) }}
                >
                    <Marker
